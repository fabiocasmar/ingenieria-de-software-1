...
urlpatterns = patterns('',
    ...
    url(r'^mover_reserva_2$', views.mover_reserva_2, name = 'mover_reserva_2'),
    url(r'^reserva_devolver_dinero$', views.reserva_devolver_dinero, name = 'reserva_devolver_dinero'),
    url(r'^pagar_servicio_reembolso$', views.pagar_servicio_reembolso, name = 'pagar_servicio_reembolso'),
    url(r'^pagar_servicio_reembolso_tarjeta$', views.pagar_servicio_reembolso_tarjeta, name = 'pagar_servicio_reembolso_tarjeta'),
    url(r'^pagar_servicio_reembolso_billetera$', views.pagar_servicio_reembolso_billetera, name = 'pagar_servicio_reembolso_billetera'),
