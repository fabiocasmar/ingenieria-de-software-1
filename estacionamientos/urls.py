...
urlpatterns = patterns('',
    ...
    url(r'^(?P<_id>\S+)/propietario_crear_editar$', views.propietario_crear_editar, name = 'propietario_crear_editar'),
    url(r'^(?P<_id>\S+)/crear_estacionamiento$', views.crear_estacionamiento, name = 'crear_estacionamiento'),
